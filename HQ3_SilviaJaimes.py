...
def inicio_juego():
    print("¡¡¡Bienvenidx a triqui o(0w0)o!!!")
    time.sleep(1)
    while True:
        ...
        if ficha=="X":
            ...
            print("Por favor, ingrese bien su ficha")
...
def victoria(matriz):
    if(matriz[0]==matriz[1]==matriz[2]!=" " or matriz[3]==matriz[4]==matriz[5]!=" " or matriz[0]==matriz[3]==matriz[6]!=" " or matriz[1]==matriz[4]==matriz[7]!=" " or matriz[2]==matriz[5]==matriz[8]!=" " or matriz[0]==matriz[4]==matriz[8]!=" " or matriz[2]==matriz[4]==matriz[6]!=" "):
        return True
    else:
        return False
